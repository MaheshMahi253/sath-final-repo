    ...
    <NRILayout>
      <div className="home-container">
        ...
        <section className="hero">
          ...
          <p>Connect with rural kids through guided virtual sessions to enhance your confidence and cultural awareness.</p>
        </section>
        ...
        <section className="cta">
          ...
          <a href="/dashboard/rural/schedule" className="cta-button">Book a Session</a>
        </section>
      </div>
