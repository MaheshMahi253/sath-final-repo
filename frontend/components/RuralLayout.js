...
export default function RuralLayout({ children }) {
  ...
  const links = [
    { href: "/dashboard/rural/home", label: "Home" },
    { href: "/dashboard/rural/schedule", label: "Schedule" },
    { href: "/dashboard/rural/feedback", label: "Feedback" },
    { href: "/dashboard/rural/confirmed", label: "Confirmed Sessions" },
  ];

  return (
    <div className="rural-container">
      <header className="rural-header">
        <h1 className="rural-title">BridgeConnect - Rural</h1>
